...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyCoin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyCoin_t qt_meta_stringdata_MyCoin = {
    {
QT_MOC_LITERAL(0, 0, 6) // "MyCoin"
...
static const uint qt_meta_data_MyCoin[] = {
...
QT_INIT_METAOBJECT const QMetaObject MyCoin::staticMetaObject = { {
    &QPushButton::staticMetaObject,
    qt_meta_stringdata_MyCoin.data,
    qt_meta_data_MyCoin,
    qt_static_metacall,
    nullptr,
    nullptr
